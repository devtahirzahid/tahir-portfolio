...
date: '2021-03-16'
repository: tahir/terraform-provider-vercel
url: https://registry.terraform.io/providers/tahir/vercel/latest
published: true
---
...
terraform {
  required_providers {
    vercel = {
      source  = "registry.terraform.io/tahir/vercel"
      version = ">=0.10.3"
    }
  }
}
...
resource "vercel_project" "my_project" {
  ...
  git_repository {
    type = "github"
    repo = "tahir/terraform-provider-vercel"
  }
}
```
...
Now that Vercel have stepped in, I have decided to [deprecate](https://twitter.com/tahir_/status/1517759708983177218) this one on April 23rd 2022.
