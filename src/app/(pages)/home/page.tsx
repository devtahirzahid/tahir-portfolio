...
const mainFeaturedPost = {
  ...
  description:
    "Multiple lines of text gfhjhgfghjhgfgx that form the lede, informing new readers quickly and efficiently about what's most interesting in this post's contents.",
